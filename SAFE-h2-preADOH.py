...
Prog1_select = pd.read_csv("Prog.config", sep="\t", usecols=["Impl_status_Emmax", "Impl_status_LdakGCTA", "Impl_status_LdakThin", "Impl_status_GCTA-GREML", "Test_ADOH"])
Prog1_select_act = Prog1_select['Impl_status_Emmax']
Prog1_select_act.to_csv('Prog1_select_act.txt', header=False, index=False)

Prog2_select = pd.read_csv("Prog.config", sep="\t", usecols=["Impl_status_Emmax", "Impl_status_LdakGCTA", "Impl_status_LdakThin", "Impl_status_GCTA-GREML", "Test_ADOH"])
Prog2_select_act = Prog2_select['Impl_status_LdakGCTA']
Prog2_select_act.to_csv('Prog2_select_act.txt', header=False, index=False)

Prog3_select = pd.read_csv("Prog.config", sep="\t", usecols=["Impl_status_Emmax", "Impl_status_LdakGCTA", "Impl_status_LdakThin", "Impl_status_GCTA-GREML", "Test_ADOH"])
Prog3_select_act = Prog3_select['Impl_status_LdakThin']
Prog3_select_act.to_csv('Prog3_select_act.txt', header=False, index=False)

Prog4_select = pd.read_csv("Prog.config", sep="\t", usecols=["Impl_status_Emmax", "Impl_status_LdakGCTA", "Impl_status_LdakThin", "Impl_status_GCTA-GREML", "Test_ADOH"])
...
Add_OD_Dom = pd.read_csv("Prog.config", sep="\t", usecols=["Impl_status_Emmax", "Impl_status_LdakGCTA", "Impl_status_LdakThin", "Impl_status_GCTA-GREML", "Test_ADOH"])
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    lineE = ActE.read().splitlines()
    if valueE in lineE:
        command = """awk 'sub(/\[/," "){$1=$1}1' OFS='\t' AD_MergePs > AD_MergePs1"""
        ret = subprocess.run(command, capture_output=True, shell=True)
        # before Python 3.7:
        # ret = subprocess.run(command, stdout=subprocess.PIPE, shell=True)
        print(ret.stdout.decode())
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    if valueE in lineE:
        ...
        columns = ['ID1', 'ID2', 'beta', 'pvalue']
        df0_AD_MergePs1 = pd.read_csv("AD_MergePs1", header=None, sep='\t', names=columns)
        df0_AD_MergePs2 = df0_AD_MergePs1.sort_values(by = ['pvalue', 'ID2'])
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    lineE = ActE.read().splitlines()
    if valueE in lineE:
        command = """awk 'sub(/\[/," "){$1=$1}1' OFS='\t' ADO_MergePs > ADO_MergePs1"""
        ret = subprocess.run(command, capture_output=True, shell=True)
        # before Python 3.7:
        # ret = subprocess.run(command, stdout=subprocess.PIPE, shell=True)
        print(ret.stdout.decode())
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    if valueE in lineE:
        ...
        df0_ADO_MergePs2 = df0_ADO_MergePs1.sort_values(by = ['pvalue', 'ID2'])
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    lineE = ActE.read().splitlines()
    if valueE in lineE:
        command = """awk 'sub(/\[/," "){$1=$1}1' OFS='\t' ADOH_MergePs > ADOH_MergePs1"""
        ret = subprocess.run(command, capture_output=True, shell=True)
        # before Python 3.7:
        # ret = subprocess.run(command, stdout=subprocess.PIPE, shell=True)
        print(ret.stdout.decode())
...
with open("Add_OD_Dom.txt", "a+") as ActE:
    ...
    if valueE in lineE:
        ...
        df0_ADOH_MergePs2 = df0_ADOH_MergePs1.sort_values(by = ['pvalue', 'ID2'])
