...
There is an updated version at https://github.com/SAFE-h2/SAFE-h2-v2026-1
...
The run will create and save the output folders of files and figures for the original   phenotype (named as SAFE_...) and for the random phenotypes 1 to 6 (named as RP1_... to RP6_...). SAFE-h2 also provides the user with aligned graphs and related datasets (named as RP1_6…). 
